...
QT_MOC_LITERAL(3, 23, 8)
    ...
    "Spectrum\0audioDropped\0\0fileName\0"
};
...
void Spectrum::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->audioDropped((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Spectrum::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Spectrum::audioDropped)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Spectrum::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Spectrum.data,
...
// SIGNAL 0
void Spectrum::audioDropped(QString _t1)
{
